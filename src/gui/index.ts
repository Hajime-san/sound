...
export const tick = (currentScale: frequencyToScaleData.PitchName, volume: number, bpm: number, lowerMaxFr: number, lowerAvgFr: number, upperMaxFr: number, upperAvgFr: number) => {
